            ...
            <div className='About-content'>
                <section className='About-section'>
                    ...
                    <p className='About-sectionText'>
                        ...
                        <a href='https://company.wizards.com/fancontentpolicy'>Wizards of the Coast Fan Content Policy</a>. Blackblade is in no way
                        approved or endorsed by Wizards. Portions of the materials (including but not limited to oracle text, card images, and card
                        logos) used are property of Wizards of the Coast. &copy; Wizards of the Coast LLC.
                    </p>
                </section>
                <section className='About-section'>
                ...
                <section className='About-section'>
                    ...
                    <p className='About-sectionText'>
                        ...
                        <a href='https://www.tcgplayer.com/'>TCGPlayer</a>. Prices are in USD, and are <strong>ONLY</strong> estimates. Prices are
                ...
                <section className='About-section'>
                    ...
                    <p className='About-sectionText'>
                        Blackblade is open source. You can find the code for the website <a href='https://github.com/BrandonWade/blackblade'>here</a>,
                        and the code for the batch that retrieves Scryfall's data weekly can be found{' '}
                        <a href='https://github.com/BrandonWade/blackblade-batch'>here</a>.
                    </p>
                </section>
            </div>
        </HeaderPage>
